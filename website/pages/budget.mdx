...
<Callout type="info">
  **Phase 1 — designed, not yet shipped.** The API shape below is a proposal so
  the design can be argued about concretely; the committed part is the
  behaviour and the acceptance bar. See [Roadmap](/roadmap) and
