...
<Callout type="info">
  **Phase 1 — designed, not yet shipped.** Command and decorator names below
  are a proposal; the committed part is the behaviour and the acceptance bar.
...
fabric mock          # the local simulator
