...
LlamaIndex gets a governed `OpenAILike` LLM pointed at the MuleSoft LLM proxy,
...
model = OpenAILike(
    model="gpt-4o",
    api_base=...,                     # from MULESOFT_LLM_PROXY_URL, no /v1 suffix
    api_key=...,
...
> the MuleSoft LLM proxy. This is the single most common LlamaIndex-with-a-
