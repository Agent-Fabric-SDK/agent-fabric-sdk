...
The blocking client from `fabric.llm.client(sync=True)` behaves identically here
...
clients retry 429/502/503/504 and treat other 4xx as terminal. The async client
