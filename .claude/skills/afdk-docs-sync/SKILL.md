...
| "The framework adapter is shallow / `connection_kwargs()`-only" | LlamaIndex still has a `frameworks/llamaindex.mdx` page. Support depth changes what claims the page can make, not whether it needs updating. |
